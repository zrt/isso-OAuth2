...
define('app/i18n',["app/config",
        "app/i18n/en", 
        "app/i18n/zh_CN"],
        function(config, en, zh) {
...
define('app/api',["app/lib/promise", "app/globals"], function(Q, globals) {
    ...
    var create = function(tid, data) {
        ...
        var winObj = window.open('https://cmt.enj0.com/new?'+qs({uri: tid || location}) + '&data=' + encodeURIComponent(JSON.stringify(data)), 'GitHub OAuth', 'width=700,height=400,menubar=no,scrollbars=no' );
...
buf.push("<div class=\"isso-postbox\"><div class=\"form-wrapper\"><div class=\"textarea-wrapper\"><div contenteditable=\"true\" class=\"textarea placeholder\">" + (jade.escape(null == (jade_interp = i18n('postbox-text')) ? "" : jade_interp)) + "</div></div><section class=\"auth-section\"><p class=\"post-action\"><input type=\"submit\"" + (jade.attr("value", "使用GitHub登录并发表评论", true, false)) + "/></p></section></div></div>");}.call(this,"author" in locals_for_with?locals_for_with.author:typeof author!=="undefined"?author:undefined,"email" in locals_for_with?locals_for_with.email:typeof email!=="undefined"?email:undefined,"i18n" in locals_for_with?locals_for_with.i18n:typeof i18n!=="undefined"?i18n:undefined,"website" in locals_for_with?locals_for_with.website:typeof website!=="undefined"?website:undefined));;return buf.join("");
};  return fn;});
...
{
    if(comment.website){
        buf.push("<div class=\"avatar\"><img  src=" + comment.website.split(' ')[0]  + "></img></div>");
        comment.website = comment.website.split(' ')[1] || ''}
    else{
        buf.push("<div class=\"avatar\"><img  src=" + "https://www.gravatar.com/avatar/"  + "></img></div>");
    }
